<template>
  <div class="plane-bus-item">
    <div class="cell-box">
      <div class="cell-item cell-time">
        <div class="depart-time">{{time}}</div>
      ...
      <div class="cell-item cell-ticket">
        ...
        <span class="amount">{{amount}}张</span>
      </div>
    </div>
  </div>
</template>
...
<script>
import { formatDateHHMM } from '@/utils/date-format'
...
export default {
  ...
  data () {
    return {
      time: formatDateHHMM(this.depTime)
    }
  }
}
</script>
